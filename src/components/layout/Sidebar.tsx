...
export function Sidebar({ unreadNotificationCount }: SidebarProps) {
  return (
    <aside className="hidden md:fixed md:inset-y-0 md:left-0 md:flex md:w-64 md:flex-col md:border-r md:border-gray-100 md:bg-white md:px-4 md:py-6 dark:md:border-gray-800 dark:md:bg-gray-900">
